...
function imgError(ele, type) {
    switch (type) {
        case 1:
            ele.src = 'https://cdn.jsdelivr.net/gh/fz6m/Private-web@3.0.0/image/error/Transparent_Akkarin.th.jpg';
            break;
        case 2:
            ele.src = 'https://cdn.jsdelivr.net/gh/fz6m/Private-web@3.0.0/image/error/Transparent_Akkarin.th.jpg';
            break;
        default:
            ele.src = 'https://cdn.jsdelivr.net/gh/fz6m/Private-web@3.0.0/image/error/image-404.png';
    }
}
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (res.status == 200) {
                        ...
                        $('#upload-img-show').append('<img class="lazyload upload-image-preview" src="https://cdn.jsdelivr.net/gh/fz6m/Private-web@3.0.0/image/loading/trans.ajax-spinner-preloader.svg" data-src="' + get_the_url + '" onclick="window.open(\'' + get_the_url + '\')" onerror="imgError(this)" />');
                        lazyload();
...
function coverVideoIni() {
    if ($('video').hasClass('hls')) {
        $.getScript("https://cdn.jsdelivr.net/gh/fz6m/Private-web@3.0.0/js/main/hls.js", function(){
            var video = addComment.I('coverVideo');
...
loadCSS("https://cdn.jsdelivr.net/gh/fz6m/Private-web@3.0.0/css/main/font_679578.css");
...
// 	// $("div.comment-user-avatar").hide();
	
// 	// function upImg() {
// 	// 	const url = "/wp-content/themes/Sakura/images/custom/qq.png";
		
// 	// 	$("div.comment-user-avatar img").attr("src",url);
// 	// };
	
// 	// $("input#author").bind("input propertychange",function(){
// 	// 	if($("input#author").val() == ""){
// 	// 		$("div.comment-user-avatar").hide();
// 	// 	}
// 	// 	else {
// 	// 		upImg();
// 	// 		$("div.comment-user-avatar").show();
// 	// 	}
// 	// });
