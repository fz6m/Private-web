(function() {
    ...
    var check = [
        ...
        '讨厌', '针对', '带节奏', '吐了', 'nc', '脑残', '啥也不是', '无脑', 'b数', 'B数', '烂钱', '天龙人', '难看', '不怎么样', '恶心', '抖音', '快手', 'ks',
        '洗白', '假粉', '黑粉', '卖弄', '踏马', '口水歌', '戾气', '配吗', '欣赏不来', '神经病', '毛线', '碰瓷', '贬低', '废话', 'low', 'gun', '呸', '娘胎',
        '无语', '毛病', '看不起', '裁缝', '吃相', '踩', '尼玛', '污染', '乌烟瘴气', '玷污', '指指点点'
    ]
    var building = [
    ...
    var praise = [
        ...
        '交朋友', '我一样', '踹我', '倾诉', '沉', '没发现', '顶', '捞', '给我冲', '看到我', 'dd'
    ]
    var marketing = [
