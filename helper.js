(function() {
    ...
    var check = [
        ...
        '有病', '唱的啥', '你陪吗', '数数', '听吐', '膈应人', '瓦特', '辱华', '孙子', '淋逼', 'cao', '低龄', '比比', '逼逼', '看不惯', '网抑云', '找事',
        '你妹', '没马', '脑瘫', '不太好听', '侮辱', '别听了', '攀比', '肤浅', '不会在听', '不会再听', '家教', '拉仇恨', '叽叽'
    ]
    var building = [
        '盖楼', '冲', '打卡', '刷', '999', '1万', '10万', '第一', '沙发', '留个名', '火钳', '留名', '签到', '一臂之力', '十万', '一百万', '100w', '助力',
        '前排', '留爪', '占楼', '脚印', '占个', '站个', '助攻', '足迹', '留个', '占位置', '板凳'
    ]
    var praise = [
        '赞', '说句话', '说话', '和我说', '眼熟', '有没有', '有人', '只有我', '就我', '没人', '淹没', '蹲', '有谁', '祝我', '集合', '举手', '扩列',
        '交朋友', '我一样', '踹我', '倾诉', '沉', '没发现', '顶', '捞', '给我冲', '看到我', 'dd', '互粉', '有多少', '热评', '在线', '讚', '贊', '关注', '互关',
        '👍🏿', '举个手', '不止我', '叫我', '踢我', '对我', '跟我', '鼓励', '举个', '有1吗', '有吗', '掩埋', '谁是', '喊我', '树洞', '双数', '联系我', '私',
        '有同感', '击个掌', '有一起'
    ]
    var marketing = [
        'http', 'www', '.cn', '.com', '减了', '斤', '动态', '电台', '看看', '群', '吃饭', '穷', '听我', '歌单', '主页', 'qun', '裙', '公众号', '原版'
    ]
    var other = [
        '锤', '死', '杀', '复制', '陌生人', '抑郁', '版权', '小鬼', '混子', '三观', '档次', '可笑', '稍稍', '生气', '没必要', '对号入座', '不适合',
        '尊重', '资格', '地位', '非主流', 'fzl', '枇杷', '沾点', '没有', '唱功', '好笑', '营养', '回复', '评论', '闲事', '毁了', '菜', '不配', '屁',
        '指点', '玩应', '粉红', '没救', '@', '烂', '吐字', '丢人', '崇洋媚外', '水分', '阅读理解', '动脉'
    ]
    var htmlSource = {
