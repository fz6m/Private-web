(function() {
    ...
    var check = [
        ...
        '凭什么', '废物', 'sb', 'nm', '爬', '狗', '引战', '阴间', '阳间', '口德', '盗', '不是人', '傻', 'nt', '不喜欢', '批判', '粪', '道德',
        ...
        '假粉', '黑粉', '卖弄', '踏马', '口水', '戾气', '配吗', '欣赏不来', '神经病', '毛线', '碰瓷', '贬低', '废话', 'low', 'gun', '呸', '娘胎',
        ...
        '瑕疵', '2B', '2b', '高贵', '良莠不齐', '无病呻吟', '找茬', '舔个脸', '比你强', '误导', 'feiwu', '什么东西', '啥歌啊', '个p', '粑粑', '提鞋', '没水准',
        '屑', '德性', '德行', '爹娘', '小小年纪', '白莲', '你行你', '贵圈', 'fw', '不想听', '某些人', '扒谱', '没品', '脏话', '拿什么', '偷换概念', '糟蹋', '拉了',
        '嘴臭', '批小将', '屎', '驴踢', '毁成', '无能狂怒', '搞毛', '搞臭', '当头一棒', '有色眼镜', '很扯', '林子大了', '乱叫', '挑衅', '不舒服', '好东西',
        '目中无人', '鹦鹉学舌', '个球', '阴阳', '去你', '去您', '不礼貌'
    ]
    var building = [
    ...
    var other = [
        ...
        '恶意', '尸体', '砍', '捐给', '诽谤', '反驳', '脏字', '丢脸', '打炮', '走调', '上床', '到点', '时间到了', '钓鱼', '修养', '脑子'
    ]
    var htmlSource = {
