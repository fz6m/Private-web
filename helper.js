(function() {
    ...
    var check = [
        ...
        '假粉', '卖弄', '踏马', '口水', '戾气', '配吗', '欣赏不来', '欣赏不了', '神经病', '毛线', '碰瓷', '贬', '废', 'low', 'gun', '呸', '娘胎',
        ...
        '有病', '唱的啥', '你陪吗', '数数', '听吐', '膈应', '瓦特', '辱华', '孙子', '淋逼', 'cao', '低龄', '比比', '逼逼', '不惯', '网抑', '找事',
        ...
        '没眼', '糟践', '棒子', '是非颠倒', '忍受不了', '逆子', '害人', '无稽之谈', '粗口', '甩锅', '没头没尾', '床戏', '懂哥', '随意评价', '爪巴', '鸟事',
        ...
        '变态', '观猴', '放干净', '不知所云', '脱粉', '掉价', '倒胃口', '反华', '炒作', '不服', '撒泼', '出戏', '侵犯', '有脸', '没内涵', '圈地自萌', '争辩',
        '胡说', '渣滓', '流言蜚语', '高人一等', '气愤', '添砖加瓦', '报应', '不顺眼', '网暴', 'xxs', '抑云', '懂王', '博眼球', '毁经典', '关你什么', '算歌',
        '虚荣', '不敢恭维', '不及', '矫情', 'Diss', '剧透', '拉夸', '挨打', '脑血', '不堪入目', '嫖娼', '急眼', '变味', '张口就来', '班门弄斧', '驴叫', '不太搭',
        '逗b', '逗B', '逗比', '很次', '拼凑', '造作', '晦气'
    ]
    var building = [
    ...
    var praise = [
        ...
        '聊聊', '能看到', '认识一下', '同样感觉', '给个', '不光我', '热门', '有一样', '谁还在', '还在听', '这条上去'
    ]
    var marketing = [
    ...
    var other = [
        ...
        '争论', '安慰', '排面', '斗争', '笑话', '刻意', '拉倒', '有问题', '被人笑', '图一乐', '犯着', '维权', '细品', '离谱', '封禁', '流量', '造假'
    ]
    var htmlSource = {
