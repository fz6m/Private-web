...
(function() {
    ...
    var check = [
        ...
        '嫉妒', '配不上', '崽种', '杂种', '杂总', '拳', '不大行', '吊打', '不爱听', '碾压', '邪教', '棍吧', '拉胯', '是个人', '是人', '致郁'
    ]
    var building = [
        '盖楼', '冲', '打卡', '刷', '999', '1万', '10万', '第一', '沙发', '留个名', '火钳', '留名', '签到', '一臂之力', '十万', '一百万', '100w', '助力',
        '前排', '留爪', '占楼', '脚印', '占个', '站个', '助攻', '足迹', '留个', '占位置', '板凳', '100万', '记号', '贡献', '上万'
    ]
    var praise = [
        ...
        '有同感', '击个掌', '有一起', '祝福', '交个', '点这个', '告诉我', '感觉还没', '多少人'
    ]
    var marketing = [
    ...
    var other = [
        ...
        '指点', '玩应', '粉红', '没救', '@', '烂', '吐字', '丢人', '崇洋媚外', '水分', '阅读理解', '动脉', '啊哈', '悲哀', '搅'
    ]
    var htmlSource = {
